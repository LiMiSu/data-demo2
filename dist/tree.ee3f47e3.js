...
var find = function find(tree, node) {
  if (tree === node) {
    ...
    for (var i = 0; i < tree.children.length; i++) {
      var _result = find(tree.children[i], node);
...
var node6 = addChild(node4, 100);
var node7 = addChild(node4, 200);
var node8 = addChild(node4, 300);
console.log(tree);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5819" + '/');
...
},{}]},{},["C:/Users/SuMi/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","tree.js"], null)
