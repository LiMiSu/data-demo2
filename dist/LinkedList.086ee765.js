...
var appendList = function appendList(list, value) {
  var node = createNode(value); //创建一个新节点
  //list.next!==null

  while (list.next) {
    //这是遍历找到最后一个节点，从最后一个节点添加，如果是最后一个节点next=null，如果不是继续找
    list = list.next;
...
var list = createList(10); //只是一时的根节点，并不是一整条链，每个节点都认为自己是根节点

var node2 = appendList(list, 20);
var node3 = appendList(list, 30);
var node4 = appendList(list, 40);
var result = removeFromList(list, node3); // console.log(result);
...
},{}]},{},["C:/Users/SuMi/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","LinkedList.js"], null)
//# sourceMappingURL=/LinkedList.086ee765.js.map